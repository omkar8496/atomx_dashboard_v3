    ...
    >
      <style jsx global>{`
        ...
        @media (max-width: 640px) {
          ...
          .edit-vendor-modal__header h2 {
            font-size: 0.9rem;
          }

          .edit-vendor-modal__header p {
            font-size: 0.52rem;
          }
          ...
          .edit-vendor-modal__footer button {
            height: 36px;
            padding-inline: 20px;
            font-size: 0.72rem;
          }
      ...
      <div className="w-full max-w-[860px] max-[640px]:max-h-[calc(100dvh-24px)]">
        <div
